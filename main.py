...
def attack(char_name: str, char_class: str) -> str:
    """Описывает функцию по расчету нанесенного урона."""
...
def defence(char_name: str, char_class: str) -> str:
    """Описывает функцию по расчету блокированного урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Описывает функцию по применению специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Описывает функцию по тренировке персонажа."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Описывает функцию по выбору персонажа."""
    approve_choice: str = ''
    char_class: str = ''
